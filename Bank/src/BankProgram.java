...
public class BankProgram {
    ...
    private void newAccount(){
        ...
        System.out.println("Your acc number is"+ current);
    }
    private void select (){
        System.out.println("Enter accNum:");
        current = scanner.nextInt();
        int balance= accounts.get(current);
        System.out.println("Thr balance of acc:"+ current +"is" +balance);
    }
    ...
    private  void showAll(){
        ...
        System.out.println("The banks has "+accounts.size()+"accounts");
        for(int i:accts) {
