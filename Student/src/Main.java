public class Main {
    public static void main(String[] args) {
        ...
        Student student1 = new Student(studentIds[0], "ivan", "male");

        // Creating second student object and setting its state
        Student student2 = new Student(studentIds[1], "spas", "male");

        // Creating third student object and setting its state
        Student student3 = new Student(studentIds[2], "alex", "female");
